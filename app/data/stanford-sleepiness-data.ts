...
export class StanfordSleepinessData extends SleepData {
	...
	override dateString():string {
		let sleepStartDay = new Date (this.loggedAt);
		return "At " + sleepStartDay.toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' }) + ', ' +
			sleepStartDay.toLocaleTimeString();
	}
